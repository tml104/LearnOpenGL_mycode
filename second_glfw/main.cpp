...
int main()
{
    ...
    // new for drawing triangle (*new part)
    // ---------------------------------------
    float vertices[] = {
        -0.5f, -0.5f, 0.0f,
        0.5f, -0.5f, 0.0f,
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0); //after this is called, data in VBO is registered as the vertex attribute's bound vertex buffer object （简单来说就是不能在这个函数被调用之前解绑VBO）
