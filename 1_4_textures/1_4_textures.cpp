...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("4.1.shader_5.vs", "4.1.shader_5.fs"); // you can name your shader files however you like
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        float scale_value = sin((float)glfwGetTime());

        glm::mat4 trans_2 = glm::mat4(1.0f);
        trans_2 = glm::translate(trans_2, glm::vec3(-0.5f, 0.5f, 0.0f));
        trans_2 = glm::scale(trans_2, glm::vec3(scale_value, scale_value, scale_value));
        ourShader.setMatrix4("transform", trans_2);
